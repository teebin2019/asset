...
<head>
    <title>ประเภทเพิ่มประเภทงบประมษณ</title>
...
<body>
    <div class="container mt-5">
        <h3 class="text-center">ประเภทเพิ่มประเภทงบประมษณ</h3>
        <form method="post" id="add_create" name="add_create" action="<?= site_url('/CurrencyTypes_submit') ?>">
