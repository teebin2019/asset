...
<head>
    <title>เพิ่มข้อมูลประเภทครุภัณฑ์</title>
...
<body>
    <div class="container mt-5">
        <h3 class=text-center>เพิ่มข้อมูลประเภทครุภัณฑ์</h3>
        <form method="post" id="add_create" name="add_create" action="<?= site_url('/AssetTypes_submit') ?>">
