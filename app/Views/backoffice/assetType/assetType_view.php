            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= site_url('AssetTypes_add') ?>" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm" id="add"><i class="fas fa-download fa-sm text-white-50"></i> เพิ่มข้อมูล</a>
                    </div>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ข้อมูลประเภททั้งหมด</h6>
                        </div>
                        <div class="card-body">
                            <table id="myTable" class="table table-bordered border-dark" width="100%">
                                ...
                                <tbody>
                                    <?php foreach ($assetType as $as) : ?>
                                        <tr>
                                            <td width="23%"><?= $as['id_type'] ?></td>
                                            <td><?= $as['name_type'] ?></td>

                                            <td>
                                                <!-- เพิ่มมีการเลือกได้้ว่าใช่หรือ ไม่ -->

                                                <a href="<?= site_url('/AssetTypes_edit/' . $as['id_type']) ?> " class="btn btn-primary btn-sm" id="edit">แก้ไข</a> <a href="<?= site_url('/AssetTypes_delect/' . $as['id_type']) ?> " class="btn btn-danger btn-sm" id="delete">ลบ</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
