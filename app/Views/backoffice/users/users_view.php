                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ข้อมูลผู้ใช้งานทั้งหมด</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    foreach ($user as $u) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo base_url('User_edit/' . $u['id']); ?>" class="btn btn-primary btn-sm" id="edit">แก้ไข</a>
                                                <a href="<?php echo base_url('User_delect/' . $u['id']); ?>" class="btn btn-danger btn-sm" id="delete">ลบ</a>
                                            </td>
                                            <?php $i++ ?>
                                        </tr>
                                    <?php endforeach ?>
                    ...
                    <!-- Add this to your layout file or specific view file -->
