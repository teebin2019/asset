            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ข้อมูลผู้ซื้อขาย</h1>
                        <a href="<?= site_url('Suppliers_add') ?>" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm" id="add"><i class="fas fa-download fa-sm text-white-50"></i> เพิ่มข้อมูล</a>
                    </div>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ข้อมูลข้อมูลผู้ซื้อขายทั้งหมด</h6>
                        </div>
                        <div class="card-body">
                            <table id="myTable" class="table table-bordered border-dark" width="100%">
                                <thead class="table table-dark">
                                    <tr>
                                        ...
                                        <th>ชื่อผู้ซื้อ/ูผู้ขาย</th>
                                        <th>ที่อยู่</th>
                                        <th class="text-center" width="10%">action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($suppliers as $as) : ?>
                                        <tr>
                                            <td><?= $as['supplier_id'] ?></td>
                                            <td><?= $as['contact_person'] ?></td>
                                            <td><?= $as['address'] . ' ' . $as['phone_number'] ?></td>
                                            <td><a href="<?= site_url('Suppliers_edit/' . $as['supplier_id']) ?>" class="btn btn-primary btn-sm" id="edit">แก้ไข</a> <a href="<?= site_url('Suppliers_delect/' . $as['supplier_id']) ?>" class="btn btn-danger btn-sm" id="delete">ลบ</a></td>
                                        </tr>
                                    <?php endforeach ?>
