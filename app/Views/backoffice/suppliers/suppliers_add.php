...
<head>
    <title>เพิ่มข้อมูลผู้ซื้อขาย</title>
...
<body>
    <div class="container mt-5">
        <h3 class="text-center">เพิ่มข้อมูลผู้ซื้อ/ผู้ขาย</h3>
        <form method="post" id="add_create" name="add_create" action="<?= site_url('/Suppliers_submit') ?>">
