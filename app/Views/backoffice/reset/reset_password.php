        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-3 text-gray-800">เปลี่ยนรหัสผ่าน</h1>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!--  อัปรูปภาพ -->
                            <div class="mb-3">
                                <form action="<?= base_url('/reset_password_User') ?>" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="confire_password" type="password" id="formFile">
                                    </div>
                                    <div class="mb-3">
