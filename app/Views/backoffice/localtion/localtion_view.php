            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">สถานที่ตั้ง</h1>
                        <a href="<?= site_url('Localtion_add') ?>" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm" id="add"><i class="fas fa-download fa-sm text-white-50"></i> เพิ่มข้อมูล</a>
                    </div>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ข้อมูลสถานที่ตั้งทั้งหมด</h6>
                        </div>
                        <div class="card-body">
                            <table id="myTable" class="table table-bordered border-dark" width="100%">
                                ...
                                <tbody>
                                    <?php foreach ($localtion as $as) : ?>
                                        <tr>
                                            <td width="23%"><?= $as['id_location'] ?></td>
                                            <td><?= $as['name_location'] ?></td>
                                            <td><a href="<?= site_url('/Localtion_edit/' . $as['id_location']) ?>" class="btn btn-primary btn-sm" id="edit">แก้ไข</a>
                                                <a href="<?= site_url('/Localtion_delete/' . $as['id_location']) ?>" class="btn btn-danger btn-sm" id="delete">ลบ</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
